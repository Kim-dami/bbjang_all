...
$(document).ready(function(){
    ...
    function css_calc(){
        ...
        var wid02 = parent01 * 50 / 100 - 34 + "px"
        $(".wt_info_wrap .wt_month_price .wt_r .wt_num").css("width",wid02);
        //면적 평 너비
        var parent03 = $(".wt_info_wrap .wt_area .wt_r").width();
        var wid03 = parent01 * 50 / 100 + "px"
        $(".wt_info_wrap .wt_area .wt_r .wt_ko_unit").css("width",wid03);
        //면적 미터제곱 너비
        var parent04 = $(".wt_info_wrap .wt_area .wt_r").width();
        var wid04 = parent01 * 50 / 100 + "px"
        $(".wt_info_wrap .wt_area .wt_r .wt_is_unit").css("width",wid04);
        //면적 인풋 너비
        var parent05 = $($(".wt_info_wrap .wt_area .wt_r .wt_num ").parent()).width();
        var wid05 = parent05 - 40 + "px"
        $(".wt_info_wrap .wt_area .wt_r .wt_num").css("width",wid05);
        //추가연락처 너비
        var parent06= $(".wt_add .wt_add_l").width();
        var wid06= parent06 * 30 / 100 - 35 + "px"
        $(".wt_add .wt_add_l .wt_add_num").css("width",wid06);  
    }
